...
*Commands20Api* | [**create_command**](docs/Commands20Api.md#create_command) | **POST** /v0/enterprise/{enterprise_id}/command/
*Commands20Api* | [**get_command_request_status**](docs/Commands20Api.md#get_command_request_status) | **GET** /v0/enterprise/{enterprise_id}/command/{request_id}/status/
*Commands20Api* | [**get_device_command_history**](docs/Commands20Api.md#get_device_command_history) | **GET** /v0/enterprise/{enterprise_id}/device/{device_id}/command-history/
*Commands20Api* | [**list_command_request**](docs/Commands20Api.md#list_command_request) | **GET** /v0/enterprise/{enterprise_id}/command/
*Commands20Api* | [**partial_update_command_status**](docs/Commands20Api.md#partial_update_command_status) | **PATCH** /v0/enterprise/{enterprise_id}/command/{request_id}/status/{command_id}/
