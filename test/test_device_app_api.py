...
class TestDeviceAppApi(unittest.TestCase):
    ...
    def test_device_app_by_id(self):
        """Test case for device_app_by_id

        Get app information
        """
        pass

    def test_device_app_install_list(self):
        """Test case for device_app_install_list

        List installed apps
        """
        pass

    def test_device_app_list(self):
        """Test case for device_app_list
