...
class TestEnterpriseApplicationApi(unittest.TestCase):
    """EnterpriseApplicationApi unit test stubs"""

    def setUp(self):
        self.api = esperclient.api.enterprise_application_api.EnterpriseApplicationApi()
